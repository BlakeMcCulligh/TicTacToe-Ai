...
/**This class will create a GameBoard object and allow a round of TicTacToe to be played against another human.
 * 
*@author Mr. Aldworth
*/
public class TwoPlayer {
	
	public static void TwoPllayer() throws Exception {
		...
		while (gameOver == false) {
			errorFlag = false;
			if (turn % 2 == 0) {// if it is playerss turn
				do {
